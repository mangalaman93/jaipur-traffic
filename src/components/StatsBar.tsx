...
export function StatsBar({ data, mode = "traffic" }: StatsBarProps) {
  ...
  return (
    <div className="grid grid-cols-4 gap-2 sm:grid-cols-4 sm:gap-3">
      <div className="bg-card rounded-lg p-2 sm:p-4 border border-border">
      ...
      {mode === "severity" ? (
        <>
          <div className="bg-card rounded-lg p-2 sm:p-4 border border-red-600/30">
            <div className="text-xs text-muted-foreground mb-1">High</div>
            <div className="text-lg sm:text-2xl font-bold font-mono text-red-600">
              {stats.high}
            </div>
          </div>
          <div className="bg-card rounded-lg p-2 sm:p-4 border border-yellow-600/30">
          ...
          <div className="bg-card rounded-lg p-2 sm:p-4 border border-border/50">
            <div className="text-xs text-muted-foreground mb-1">Normal</div>
            <div className="text-lg sm:text-2xl font-bold font-mono text-muted-foreground">
              {stats.normal}
            </div>
          </div>
        </>
        ...
        <>
          <div className="bg-card rounded-lg p-2 sm:p-4 border border-traffic-dark-red/30">
            <div className="text-xs text-muted-foreground mb-1">Critical</div>
            <div className="text-lg sm:text-2xl font-bold font-mono text-traffic-dark-red">
              {stats.critical}
            </div>
          </div>
          <div className="bg-card rounded-lg p-2 sm:p-4 border border-traffic-red/30">
            <div className="text-xs text-muted-foreground mb-1">High</div>
            <div className="text-lg sm:text-2xl font-bold font-mono text-traffic-red">
              {stats.high}
            </div>
          </div>
          <div className="bg-card rounded-lg p-2 sm:p-4 border border-traffic-yellow/30">
            <div className="text-xs text-muted-foreground mb-1">Moderate</div>
            <div className="text-lg sm:text-2xl font-bold font-mono text-traffic-yellow">
              {stats.moderate}
            </div>
          </div>
        </>
